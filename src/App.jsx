    ...
    <>
      <div className="min-h-full bg-gradient-to-l from-white to-slate-300">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              <div className="flex items-center">
                ...
                <p className="flex flex-col justify-center items-center text-xl h-8 w-fit font-bold text-white">React-Chat</p>
                </div>
        ...
        {/* <header className="bg-gradient-to-l from-blue-200 via-pink-300 to-blue-700 shadow"> */}
          <div className="mx-auto w-full pl-12 py-10 pb-0">
